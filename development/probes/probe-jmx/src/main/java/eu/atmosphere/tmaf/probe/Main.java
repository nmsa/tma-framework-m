...
public class Main {
    ...
    private static final String descriptionIdCpu = PropertiesManager.getInstance().getProperty("DESCRIPTION_ID_CPU");

    private static final String descriptionIdMemory  = PropertiesManager.getInstance().getProperty("DESCRIPTION_ID_MEMORY");

    private static final String resourceId  = PropertiesManager.getInstance().getProperty("RESOURCE_ID");
    ...
    public static void main(String[] args) throws Exception{
      ...
      LOGGER.info("start {}!", start);
        ...
        while (true)
        {
           ...
           message.setResourceId(Integer.parseInt(resourceId));
           ...
           message.addData(new Data(Data.Type.MEASUREMENT, Integer.parseInt(descriptionIdMemory), new Observation(Instant.now().getEpochSecond(), Double.parseDouble(cd.get("used").toString()))));
           message.addData(new Data(Data.Type.MEASUREMENT, Integer.parseInt(descriptionIdCpu), new Observation(Instant.now().getEpochSecond(), (double)cpuDiff)));
